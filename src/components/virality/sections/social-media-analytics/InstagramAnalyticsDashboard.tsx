...
const InstagramAnalyticsDashboard: React.FC<InstagramAnalyticsDashboardProps> = ({ username }) => {
  ...
  const recentContent = [
    { 
      id: 1, 
      imageUrl: '/images/content/instagram-1.png',
    ...
    { 
      id: 2, 
      imageUrl: '/images/content/instagram-2.png',
    ...
    { 
      id: 3, 
      imageUrl: '/images/content/instagram-3.png',
    ...
    { 
      id: 4, 
      imageUrl: '/images/content/instagram-4.png',
  ...
  const newContent = [
    { 
      id: 5, 
      imageUrl: '/images/content/instagram-5.png',
    ...
    { 
      id: 6, 
      imageUrl: '/images/content/instagram-6.png',
    ...
    { 
      id: 7, 
      imageUrl: '/images/content/instagram-7.png',
    ...
    { 
      id: 8, 
      imageUrl: '/images/content/instagram-8.png',
  ...
  const lookalikesCreators = [
    { username: 'poppyzeidra', followers: '141,644', imageUrl: '/images/creators/creator-1.png' },
    { username: 'idvolunteering', followers: '599,913', imageUrl: '/images/creators/creator-2.png' },
    { username: 'berita_event', followers: '67,156', imageUrl: '/images/creators/creator-3.png' },
    { username: 'info_beasiswa', followers: '2,322,206', imageUrl: '/images/creators/creator-4.png' }
  ];
